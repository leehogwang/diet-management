...
import 'screens/meal_correction_screen.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  final List<Widget> _pages = [
    const HomePage(),
    const PlaceholderPage(title: '식단 통계'),
    const PlaceholderPage(title: '운동 기록'),
    const UserInfoPage(),
  ];
        ...
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              ...
              title: const Text('식단 보정'),
              onTap: () {
                Navigator.pop(context);
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const MealCorrectionScreen(),
                  ),
                );
              },
            ),
            ListTile(
              ...
              title: const Text('식단 목록'),
              onTap: () {
                Navigator.pop(context);
                _showPlaceholderDialog('식단 목록');
              },
            ),
            ListTile(
